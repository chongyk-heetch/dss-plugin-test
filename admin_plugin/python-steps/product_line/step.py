...
from heetchadmin.import_csv import get_action_product_line, validate_keys, env, get_df
...
validate_keys(step_config, env.campaign_passenger_config_template)

# Read recipe inputs
dataset_df = get_df(step_config)

action = get_action_product_line(df_name=step_config['dataset'],
                               df=dataset_df,
