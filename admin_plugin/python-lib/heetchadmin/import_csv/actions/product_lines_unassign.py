...
##################################### Ride comment Action ####################################
class ProdcutLinesUnassignAction(ActionInterface):
    def __init__(self,
                 df_name,
                 df,
                 token):
    ...
    def post_request(self, row):
        ...
        return requests.request("DELETE", uri, headers=self.get_headers(), json=payload, timeout=30)        
    ...
    def run(self):
        ...
        print('Running ProdcutLinesUnassignAction ...')
